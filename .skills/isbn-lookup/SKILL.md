...
- **Endpoint**：`POST https://app-bjm4peyd3x8h-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-bjm4peyd3x8h-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
