            ...
            <div className="max-w-5xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-y-3 text-sm">
                                    <div className="text-muted-foreground flex items-center gap-2"><LayoutList
                                        className="w-4 h-4"/> 报告编号
                                    </div>
                                    <div className="font-medium">AFR-2026-X892-01</div>
                                    <div className="text-muted-foreground flex items-center gap-2"><Calendar
                                        className="w-4 h-4"/> 生成时间
                                    </div>
                                    <div className="font-medium">2026-05-12 14:30:22</div>
                                    <div className="text-muted-foreground flex items-center gap-2"><Cpu
                                        className="w-4 h-4"/> AI版本
                                    </div>
                                    <div className="font-medium">Miaoda-Compliance v4.5</div>
                                    <div className="text-muted-foreground flex items-center gap-2"><History
                                        className="w-4 h-4"/> 数据截止日期
                                    </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-2 gap-y-3 text-sm">
                                    <div className="text-muted-foreground flex items-center gap-2"><Building2
                                        className="w-4 h-4"/> 企业名称
                                    </div>
                                    <div className="font-medium">中非科创出海科技有限公司</div>
                                    <div className="text-muted-foreground flex items-center gap-2"><Briefcase
                                        className="w-4 h-4"/> 所属行业
                                    </div>
                                    <div className="font-medium">数字基础设施与金融科技</div>
                                    <div className="text-muted-foreground flex items-center gap-2"><Users
                                        className="w-4 h-4"/> 企业规模
                                    </div>
                                    <div className="font-medium">500-1000人</div>
                                    <div className="text-muted-foreground flex items-center gap-2"><MapPin
                                        className="w-4 h-4"/> 出海目的国
                                    </div>
                                    <div className="font-medium">尼日利亚、肯尼亚</div>
                                    <div className="text-muted-foreground flex items-center gap-2"><Globe
                                        className="w-4 h-4"/> 出海商业模式
                                    </div>
                ...
                <Card className="border-none shadow-sm">
                    ...
                    <CardContent className="p-6 space-y-8">
                        <div
                            className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 p-6 bg-muted/30 rounded-lg">
                            ...
                            <div className="flex gap-2">
                                {Object.entries(RISK_LEVELS).map(([key, value]) => (
                                    <div key={key}
                                         className={`flex flex-col items-center gap-1 opacity-${key === 'HIGH' ? '100' : '40'}`}>
                                        <div
                                            className={`w-12 h-2 rounded-full ${key === 'LOW' ? 'bg-green-500' : key === 'MEDIUM' ? 'bg-yellow-500' : key === 'HIGH' ? 'bg-orange-500' : 'bg-red-500'}`}/>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3">
                                    {[
                                        ...
                                        <div key={index}
                                             className="flex gap-3 text-sm p-3 bg-white border rounded-md shadow-sm">
                        ...
                        {([
                            {
                                ...
                                icon: Globe,
                                level: "MEDIUM",
                                desc: "尼日利亚外商独资政策稳定，但特定行业如电信、石油需特许经营证照，审批周期预计6-12个月。",
                                impact: "项目落地时间可能超预期。",
                                action: "提前开展行业准入专项调研。"
                            },
                            {
                                ...
                                icon: Wallet,
                                level: "HIGH",
                                desc: "东非共同体(EAC)近期调整关税起征点，企业面临双重征税协定应用不熟练导致的成本溢价。",
                                impact: "预计年度运营成本上升8.5%。",
                                action: "聘请当地专业税务师进行年度税务筹划。"
                            },
                            {
                                title: "外汇管制风险",
                                icon: Gavel,
                            ...
                            },
                            {
                                ...
                                icon: Database,
                                level: "HIGH",
                                desc: "当地政府对用户个人信息存留在境外的监管趋严，违反规定可能面临全球年收入2%的罚款。",
                                impact: "重大财务损失及品牌声誉损毁。",
                                action: "实施数据服务器本地化部署或加密传输方案。"
                            },
                            {
                                title: "劳工用工风险",
                                icon: ShieldCheck,
                                level: "MEDIUM",
                                desc: "肯尼亚工会力量强大，关于加班费和医疗保险的集体谈判可能引发罢工停产风险。",
                                impact: "生产线中断，订单交付延期。",
                                action: "完善员工手册，与当地工会建立预沟通机制。"
                            },
                            {
                                title: "环保合规风险",
                                icon: Leaf,
                                level: "LOW",
                                desc: "目前业务主要为互联网技术，对环境直接影响较小，需关注办公场所的能耗及废弃物处理规定。",
                                impact: "轻微合规负担。",
                                action: "遵循绿色办公指南，定期进行碳排自测。"
                            }
                                    ...
                                    {[
                                        {
                                            ...
                                            advantage: "全球顶尖法律服务网络，深耕非洲市场30余年，政府关系卓越。"
                                        },
                                        {
                                            name: "PwC (普华永道) 尼日利亚",
                                            business: "税务筹划、审计评估、市场准入咨询",
                                            advantage: "熟悉西非地区税制变化，提供从架构设计到落地的一站式财税服务。"
                                        },
                                        {
                                            name: "Miaoda Legal AI Expert",
                                            business: "法律文本实时监控、合规文档自动生成",
                                            advantage: "24/7 实时政策抓取与智能研判，极低成本满足日常合规自查需求。"
                                        }
                                    ].map((org, i) => (
                                        <TableRow key={i}>
                                            <TableCell
                                                className="font-semibold whitespace-nowrap">{org.name}</TableCell>
                                            <TableCell className="text-sm whitespace-nowrap">{org.business}</TableCell>
                                            <TableCell
                                                className="text-sm text-muted-foreground">{org.advantage}</TableCell>
                                        </TableRow>
                                    ))}
                                </TableBody>
                            </Table>
                            ...
                            {[
                                {
                                    ...
                                    warn: "如未在规定日期前提交，可能面临每日5万奈拉的滞纳金。"
                                },
                                {
                                    date: "T+15天内",
                                    owner: "财务部主管",
                                ...
                                },
                                {
                                    ...
                                    owner: "人力资源负责人",
                                    task: "员工手册本地化修订发布",
                                    material: "现行员工手册、肯尼亚劳动法合规建议稿",
                                    warn: "修订内容需经当地工会书面确认以避免集体争议。"
                                }
                            ].map((item, i) => (
                                <div key={i}
                                     className="flex flex-col md:flex-row gap-4 p-4 border rounded-lg bg-white relative">
                                    ...
                                    <div className="flex-1 space-y-2">
                                        ...
                                        <div
                                            className="flex items-start gap-2 p-3 bg-red-50 border border-red-100 rounded-md">
                ...
                <Card className="border-none shadow-sm bg-muted/20">
                    ...
                    <CardContent className="p-6 space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-3">
                                ...
                                <p className="text-xs text-muted-foreground leading-relaxed">
                                    本报告数据源自：目的国官方政府公报、世界银行(World
                                    Bank)非洲地区年度营商环境数据库、国际货币基金组织(IMF)外汇管理政策报告、以及Baker
                                    McKenzie非洲实操案例库。AI分析模型通过Miaoda Compliance引擎实时交叉核验。
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="pt-4 text-center">
                            <p className="text-[10px] text-muted-foreground">© 2026 Miaoda Compliance System. All Rights
                                Reserved.</p>
                        </div>
                    </CardContent>
                </Card>
